...
const JobDetail = ({
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-20 p-6 max-w-7xl mx-auto">
      {/*right half*/}
      <div className="w-full mt-10 lg:w-2/3 space-y-6">
        {/*description*/}
        <div>
          <h1 className="Maintext pb-3">Description</h1>
          <p className="font-">{description}</p>
        </div>
        {/* responsibility*/}

        <div>
          <h1 className="Maintext pb-3">Responsibilities</h1>
        ...
        {/*ideal candidate*/}
        <div>
          <h1 className="Maintext pb-3">Ideal Candidate we want</h1>
          <ul className="list-disc pl-5 space-y-2">{idealCandidate}</ul>
        </div>
        {/*when and where*/}
        <div>
          <h1 className="Maintext pb-3">When & Where</h1>
      ...
      <div className="w-full  lg:w-1/3 space-y-6">
        {/*about*/}
        <div className="border-b-1 border-b-gray-200 pb-4">
          <h1 className="Maintext">About</h1>
        ...
        <div className="border-b-1 border-b-gray-300 pb-4">
          <h1 className="Maintext ">Categories</h1>
        ...
        {/*required skills*/}
        <div className="border-b-1 border-b-gray-300 pb-4">
          <h1 className="Maintext">Required Skills</h1>
          <ul className="flex gap-2 flex-wrap">
            {requiredSkills.map((skill, index) => (
              <li
                key={index}
                className="bg-gray-100 text-indigo-800 px-2 py-1 rounded"
              >
                {skill}
              </li>
            ))}
